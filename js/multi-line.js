(function(){
	// basic SVG setup
	var margin = { top: 20, right: 170, bottom: 30, left: 70 };
	...
	d3.csv("./../data/investors/stock_5_years_columns.csv", function(d) {
			return {
				...
				Nvidia: +d.Nvidia,
				Ferrari: +d.Ferrari,
				ManufacturerAverage: +d.ManufacturerAverage
			};
		}, 
		function(error,data) {
			...
			function mousemove() {
				...
				var close = d3.max([+d.Google,+d.Tesla,+d.Nvidia,+d.Ferrari, +d.ManufacturerAverage]);
